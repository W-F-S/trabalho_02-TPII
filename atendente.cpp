...
Atendente* Atendente::buscar_atendente(int id)
{
    ...
    {
        throw QString("Erro ao tentar abrir a pasta da funcionaria");
    ...
    {
        throw QString("Erro ao tentar abrir o arquivo em modo de leitura");
        exit(1);
        //return false;
    }
    QTextStream in{&arquivo};
...
bool Atendente::deletar_usuario(int id)
{
    ...
    if(!(resp == 's'))
    {
         std::cout << "operação cancelada" << endl;
        return false;
    }
...
Medico* Atendente::buscar_medico(int id)
{
    ...
    {
        throw QString("Erro ao tentar abrir a pasta do médico");
...
Pasciente* Atendente::buscar_pasciente(int id)
{
    ...
    {
        throw QString("Erro ao tentar abrir a pasta do pasciente");
...
{
    QString texto=Atendente::getNome()+"\n"+
    QString::number(Atendente::getCpf())+"\n"+Atendente::getEmail()+"\n"+
    QString::number(Atendente::getTelefone())+"\n"+
    QString::number(Atendente::getTelefone_whatsapp())+"\n"+
    QString::number(Atendente::getNum_matricula()) +"\n"+
    Atendente::get_Secretaria_geral() +"\n"+
    Atendente::get_medicos_assessorados()[0] +"\n"+
    Atendente::get_medicos_assessorados()[1] +"\n"+
    Atendente::get_medicos_assessorados()[2];
    return texto;
}
}
