...
void Login::on_pushButton_login_clicked()
{
  ...
  qDebug() << cpf; //apenas para debug
  qDebug() << senha; //apenas para debug
          ...
          case 1:
            {
              ...
              dwp::Medico *tmp2 = tmp.buscar_medico(busca.split(',')[1].toInt());
              tmp2->mostrar_dados();
              Medico_tela janela_medico{this, tmp2};
              janela_medico.setModal(true);
              janela_medico.exec();
