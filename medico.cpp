...
Medico::Medico(QString nome, long cpf, QString email, long telefone, long telefone_whatsapp, QString senha, QString especialidade,  bool particular, long crm, QString *convenio)
{
    Sistema::setNome(nome);
    Sistema::setCpf(cpf);
    Sistema::setEmail(email);
