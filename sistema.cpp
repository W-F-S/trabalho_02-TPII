...
int Sistema::gerar_num_matricula(){
    ...
    if(!infile.exists()){
        throw QString("arquivo inexistente");
    }

    if( !infile.open(QIODevice::ReadOnly | QIODevice::Text) )
    {
        throw QString("erro ao abrir o arquivo de ids");
    }
...
QString Sistema::adicionar_lista_usuarios(int tipo, int id,long cpf, QString senha)
{
    ...
    if(!arquivo.exists())
    {
        throw QString ("arquivo de dados não existente");
    }

    if (!arquivo.open(QIODevice::ReadWrite | QIODevice::Text))
    {
        throw QString ("Erro ao tentar criar o aquivo");
        return " ";
    }
...
QString Sistema::mostar_usuario()
{
        QString texto= Sistema::getNome()+"\n"+Sistema::getCpf()+"\n"+Sistema::getEmail()
                +"\n"+Sistema::getTelefone()+"\n"+Sistema::getTelefone_whatsapp()+"\n"+
                Sistema::getNum_matricula();
        return texto;
}
