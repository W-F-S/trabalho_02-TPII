...
namespace dwp
{
  ...
  bool Sistema::deletar_usuario(int id)
  {
    QFile arquivo{"lista_usuarios.txt"};
    QString tmp = "";
    QString dados = "";
  ...
  /**
   * Função que retorna o absolute path do usuario
   *
  ...
  {
    QDir *path = new QDir();
    QString dados = buscar_usuario(id);
    QString pasta;
    bool ok;
  ...
  /**
   * Função destinada a fazer a autenticação do usuario
   * @brief Sistema::login
